...
<div region="center" border="false">
  <div id="toolbar" class="datagrid-toolbar" style="height: auto;">
  	<br/>
    <fieldset>
    <legend>新增SysKey</legend>
    <form id="userForm" name="userForm" method="post">
      <table class="tableForm" align="center">
		<tr>	
			<th>关联类型：</th>		
			<td>
			<input id="linkType" name="linkType" type="text" class="easyui-validatebox easyui-textbox" maxlength="10" />
			</td>
		</tr>	
		<tr>	
			<th>关联ID：</th>		
		...
		<tr>	
			<th>key值：</th>		
			<td>
			<input id="keyValue" name="keyValue" type="text" class="easyui-validatebox easyui-textbox" maxlength="500" />
			</td>
		</tr>	
        <tr>
...
saveParam_saveUrl = 'manage/sys/sysKey/add.do';// 保存URL地址
