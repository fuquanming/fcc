...
function editStatus(areaStatus) {
    gridConfirm({
        ...
        userFormId : 'userForm',
        operateUrl : '${basePath}manage/sys/area/show.do?nodeStatus=' + areaStatus,
        fieldId : 'id',
...
treegridParam_url = '${basePath}manage/sys/area/treegrid.do';// 数据源url
...
operateParam_addUrl = '${basePath}manage/sys/area/toAdd.do';
operateParam_add_beforeCallback = function(row) {
    var id = '';
    if (row && row != undefined) {
        id = row.id;
    }
    operateParam_addUrl = '${basePath}manage/sys/area/toAdd.do?parentId=' + id;
}
operateParam_editUrl = '${basePath}manage/sys/area/toEdit.do';
operateParam_edit_beforeCallback = function(row) {
}
operateParam_delUrl = '${basePath}manage/sys/area/delete.do';
</script>