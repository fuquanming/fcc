...
<div region="center" border="false">
  <div id="toolbar" class="datagrid-toolbar" style="height: auto;">
    <br/>
    <fieldset>
    <legend>新增SysAnnex</legend>
      <form id="userForm" name="userForm" method="post">
      <table class="tableForm" align="center">
        <input name="annexType" value="activity"/>
        <tr>    
            <th>关联ID：</th>      
            <td>
        ...
        <tr>    
            <th>附件名称：</th>      
            <td>
            <input id="annexName" name="annexName" type="text" class="easyui-validatebox easyui-textbox" maxlength="50" />
            </td>
        </tr>   
        <tr>    
            <th>文件名称：</th>      
            <td>
            <input id="fileName" name="fileName" type="text" class="easyui-validatebox easyui-textbox" maxlength="50" />
            </td>
        </tr>   
        <tr>    
            <th>文件类型：</th>      
            <td>
            <input id="fileType" name="fileType" type="text" class="easyui-validatebox easyui-textbox" maxlength="50" />
            </td>
        </tr>   
        <tr>    
            <th>文件地址：</th>      
            <td>
            <textarea rows="5" cols="40" id="fileUrl" name="fileUrl" class="easyui-validatebox textbox eaayui-textarea" validType="length[0, 100]"></textarea>
            </td>
        </tr>
        <tr>    
            <th>文件大小：</th>      
            <td>
            <input id="fileSize" name="fileSize" type="text" class="easyui-validatebox easyui-textbox" maxlength="19" />
            </td>
        </tr>   
        <tr>    
            <th>文件备注：</th>      
