  ...
  <div id="toolbar" class="datagrid-toolbar" style="height: auto;">
    ...
    <form id="userForm" name="userForm" method="post">
      ...
      <table class="tableForm" align="center">
        <tr>
          <th>帐号</th>
          <td><input name="userId" type="text" class="easyui-validatebox easyui-textbox" data-options="prompt:'请输入账号...'" required="true" maxlength="20"/></td>
        </tr>
        <tr>
          <th>姓名</th>
          <td><input name="userName" type="text" class="easyui-validatebox easyui-textbox" data-options="prompt:'请输入姓名...'" required="true" maxlength="20"/></td>
        </tr>
        <tr>
          <th>Email</th>
          <td><input name="email" type="text" class="easyui-validatebox easyui-textbox" data-options="prompt:'请输入邮箱...'" validType="email" maxlength="100" required="true"/></td>
        </tr>
        <tr>
          <th>手机</th>
          <td><input name="mobile" type="text" class="easyui-validatebox easyui-textbox" data-options="prompt:'请输入手机...'" validType="mobile" required="true" />
          </td>
        </tr>
        <tr>
          <th>电话</th>
          <td><input name="tel" type="text" class="easyui-validatebox easyui-textbox" validType="telephone" maxlength="20"/>
          </td>
        </tr>
        <tr>
			<th>组织机构</th>
