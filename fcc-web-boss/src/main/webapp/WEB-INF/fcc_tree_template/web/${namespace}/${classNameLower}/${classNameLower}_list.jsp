...
function editStatus(areaStatus) {
    gridConfirm({
        ...
        userFormId : 'userForm',
        operateUrl : '${jspFileBasePath}/show.do?nodeStatus=' + areaStatus,
        fieldId : 'id',
...
treegridParam_url = '${jspFileBasePath}/treegrid.do';// 数据源url
...
operateParam_add_beforeCallback = function(row) {
    ...
    operateParam_addUrl = '${jspFileBasePath}/toAdd.do?parentId=' + id;
}
