...
<div region="center" border="false" style="overflow: auto;">
  <div id="toolbar" class="datagrid-toolbar" style="height: auto;">
    ...
    <table class="tableForm" align="center">
      <tr>
        <th>角色名称</th>
        <td><input name="roleName" class="easyui-validatebox easyui-textbox" data-options="prompt:'请输入角色名称...'" required="true" maxlength="100"/></td>
      </tr>
      <tr>
        <th>角色描述</th>
        <td>
        <textarea rows="2" cols="40" name="roleDesc" class="easyui-validatebox textbox eaayui-textarea" data-options="prompt:'请输入角色描述...'" required="true" validType="length[1, 200]"></textarea>
        </td>
      </tr>
      <!-- <tr>
      	<th>模块权限</th>
    ...
    formatter : function(value, rowData, rowIndex) {
        if (value) {
            ...
            for (var i in operates) {
                ...
                str += '<input type="checkbox" name="module_' + rowData.attributes.parentIds + '" operate="' + operates[i].operateValue + '" moduleId="' + rowData.id + '" onclick="checkOperate(this)"/>' + operates[i].operateName;
            }
            return str;
        }
        return value;
