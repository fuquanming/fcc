...
<body topmargin="0" background="images/sysinfo/bgcolor.gif">

	<table width="760" height="20" border="0" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<td align="center">选项：<a href="manage/sysinfo/sys_info.jsp#ServerInfo">服务器相关参数</a> | <a href="manage/sysinfo/sys_info.jsp#JAVAInfo">JAVA相关参数</a> | <a href="manage/sysinfo/sys_info.jsp#Paramter">参数查询</a> | <a href="manage/sysinfo/sys_info.jsp#ServerAbility">服务器运算能力</a> | <a href="manage/sysinfo/sys_info.jsp#ISpeedTest">服务器连接速度</a> | <a href="javascript:location.reload()">刷新</a> <a name="ServerInfo"></a></td>
		</tr>
	</table>
	...
	<table width="760" border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
		<tr>
			<td background="images/sysinfo/h.gif" height="20">
	...
	<table width="760" border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
		<tr>
			<td background="images/sysinfo/h.gif">
				<table border=0 width=100% cellspacing=1 cellpadding=3>
					<tr>
	...
	<table border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
		<tr>
			<td background="manage/sysinfo/images/h.gif">
				<table border=0 width=100% cellspacing=1 cellpadding=3>
					<tr>
